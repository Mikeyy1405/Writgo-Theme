            ...
            <div class="wa-footer-grid">
                ...
                <div class="wa-footer-col wa-footer-about">
                    ...
                    <div class="wa-footer-disclosure">
                        ...
                        <span class="wa-disclosure-text"><?php echo esc_html(get_theme_mod('writgo_footer_disclosure', 'Deze website bevat affiliate links. Bij aankoop ontvangen wij een kleine commissie, zonder extra kosten voor jou.')); ?></span>
                    </div>
                </div>
                
                <!-- Column 2: Navigatie -->
                <div class="wa-footer-col">
                    <h4 class="wa-footer-title">Navigatie</h4>
                ...
                <div class="wa-footer-col">
                    ...
                    <ul class="wa-footer-menu">
                        <li><a href="<?php echo home_url('/privacyverklaring/'); ?>">Privacyverklaring</a></li>
                        <li><a href="<?php echo home_url('/cookiebeleid/'); ?>">Cookiebeleid</a></li>
                        <li><a href="<?php echo home_url('/disclaimer/'); ?>">Disclaimer</a></li>
                        <li><a href="<?php echo home_url('/algemene-voorwaarden/'); ?>">Algemene Voorwaarden</a></li>
                    </ul>
                </div>
                ...
                <div class="wa-footer-col">
                    ...
                    <ul class="wa-footer-contact">
                        ...
                        <!-- Always show contact page link -->
                        <li>
                            <span class="wa-contact-icon">💬</span>
                            <a href="<?php echo home_url('/contact/'); ?>">Stuur ons een bericht</a>
                        </li>
                    </ul>
        ...
        <div class="wa-container-wide">
            <div class="wa-footer-bottom-inner">
                ...
                <div class="wa-footer-badges">
                    <span class="wa-badge-item" title="SSL Beveiligd">🔒 SSL</span>
                    <span class="wa-badge-item" title="AVG/GDPR Compliant">📋 AVG</span>
                    <span class="wa-badge-item" title="Affiliate Partner">💼 Affiliate</span>
                </div>
            </div>
        </div>
    </div>
